...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        ...
        const prompt = 'Identify the main object in this image. Return a JSON object with a single key "itemName" describing the object in 2-3 words (in Korean if appropriate, or English). Do not use Markdown formatting.';
