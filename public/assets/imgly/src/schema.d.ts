...
import { z } from 'zod';
declare const ConfigSchema: z.ZodEffects<
  z.ZodDefault<
    z.ZodObject<
      {
        ...
        progress: z.ZodOptional<
          z.ZodFunction<
            z.ZodTuple<[z.ZodString, z.ZodNumber, z.ZodNumber], z.ZodUnknown>,
            z.ZodVoid
          >
        >;
        model: z.ZodDefault<
          z.ZodEffects<
            z.ZodEnum<['isnet', 'isnet_fp16', 'isnet_quint8']>,
          ...
          z.ZodObject<
            {
              format: z.ZodDefault<
                z.ZodEnum<
                  ['image/png', 'image/jpeg', 'image/webp', 'image/x-rgba8', 'image/x-alpha8']
                >
              >;
